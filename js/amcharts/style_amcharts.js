...
am4core.ready(function() {
  ...
  var backgroundColor = am4core.color("#0000");
  var activeColor = am4core.color("#7F1111");
  var confirmedColor = am4core.color("#EC2222");
  var recoveredColor = am4core.color("#11457F");
  var deathsColor = am4core.color("#7F8285");

  // for an easier access by key
  var colors = { active: activeColor, confirmed: confirmedColor, recovered: recoveredColor, deaths: deathsColor };

  var countryColor = am4core.color("#000");
  var countryStrokeColor = am4core.color("#fff");
  var buttonStrokeColor = am4core.color("#E65810");
  var countryHoverColor = am4core.color("#fff");
  var activeCountryColor = am4core.color("#E65810");

  var currentIndex;
  var currentCountry = "Tunis";
  ...
  mapChart.geodata = am4geodata_tunisiaHigh;
  ...
  imageTemplate.tooltipText = "{name_ar}: [bold]{value}[/]";
  ...
  chartAndSliderContainer.background.fill = am4core.color("#E65810");
  chartAndSliderContainer.background.cornerRadius(5, 5, 0, 0)
  chartAndSliderContainer.background.fillOpacity = 0.90;
  ...
  sizeLabel.tooltipText = "Some governorates have so many cases that bubbles for governorates with smaller values often look the same even if there is a significant difference between them. This slider can be used to increase maximum size of a bubble so that when you zoom in to a region with relatively small values you could compare them anyway."
  sizeLabel.fill = am4core.color("#ffffff");
  ...
  filterLabel.tooltipText = "This filter allows to remove governorates with many cases from the map so that it would be possible to compare governorates with smaller number of cases."
  filterLabel.fill = am4core.color("#ffffff");
  ...
  seriesTypeSwitch.leftLabel.text = "Nbre de cas Confirmés ";
  seriesTypeSwitch.rightLabel.text = "Nbre de cas journaliers"
  ...
  var series = { confirmed: confirmedSeries, recovered: recoveredSeries, deaths: deathsSeries };
  // add series
  ...
  var buttons = { confirmed: confirmedButton, active: activeButton, recovered: recoveredButton, deaths: deathsButton };
  ...
  function updateCountryName() {
    countryName.text = currentCountry + ", " + mapChart.dateFormatter.format(currentDate, " dd MMM, yyyy");
  }
